...
#![cfg_attr(feature = "cargo-clippy", warn(clippy::cast_possible_truncation))]
#![cfg_attr(feature = "cargo-clippy", warn(clippy::cast_possible_wrap))]
#![cfg_attr(feature = "cargo-clippy", warn(clippy::cast_precision_loss))]
#![cfg_attr(feature = "cargo-clippy", warn(clippy::cast_sign_loss))]
#![cfg_attr(feature = "cargo-clippy", warn(clippy::enum_glob_use))]
#![cfg_attr(feature = "cargo-clippy", warn(clippy::mut_mut))]
#![cfg_attr(feature = "cargo-clippy", warn(clippy::mutex_integer))]
#![cfg_attr(feature = "cargo-clippy", warn(clippy::non_ascii_literal))]
...
#![cfg_attr(feature = "cargo-clippy", warn(clippy::single_match_else))]
#![cfg_attr(feature = "cargo-clippy", warn(clippy::string_add))]
#![cfg_attr(feature = "cargo-clippy", warn(clippy::string_add_assign))]
#![cfg_attr(feature = "cargo-clippy", warn(clippy::unicode_not_nfc))]
